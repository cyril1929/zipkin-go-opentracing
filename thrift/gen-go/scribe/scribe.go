...
func (p *ScribeClient) LastResponseMeta_() thrift.ResponseMeta {
  return p.meta
}

func (p *ScribeClient) SetLastResponseMeta_(meta thrift.ResponseMeta) {
  p.meta = meta
}
...
func NewScribeProcessor(handler Scribe) *ScribeProcessor {
  ...
  self3 := &ScribeProcessor{handler:handler, processorMap:make(map[string]thrift.TProcessorFunction)}
  self3.processorMap["Log"] = &scribeProcessorLog{handler:handler}
return self3
}
